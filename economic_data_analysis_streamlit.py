...
class EconomicDataAnalysis:
    ...
    def display_app_information(self):
        ...
        st.write('Data load starts after selection of output types. To avoid data load after each parameter change deactivate checkboxes for output during selection of indicators or countries.')
